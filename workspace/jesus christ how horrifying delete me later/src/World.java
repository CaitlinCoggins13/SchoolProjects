...
public class World
{
	...
	public World(int cost){
		...
		//MAZE 3
		//buildObstacle(3,6,3,7);
		//buildObstacle(4,6,5,6);
		
		//MAZE 4
		//buildObstacle(2,2,2,4);
		//buildObstacle(3,2,4,2);
		//buildObstacle(4,3,4,4);
		//buildObstacle(3,4,3,4);
		//buildObstacle(1,5,2,5);
		
		//Maze 5
		//buildObstacle(4,2,4,4);
		//buildObstacle(5,4,5,4);
		//buildObstacle(2,5,2,7);
		//buildObstacle(1,7,1,7);
		//buildObstacle(4,6,4,7);
		//buildObstacle(5,6,5,6);
		
		//Maze 6
		//buildObstacle(2,2,4,2);
		//buildObstacle(4,3,4,7);
		//buildObstacle(5,7,5,7);
	...
	public void setStepsFromGoal(Cell c)
	{
		...
		while(!frontier.isEmpty())
		{
			...
			if(checkCell.getX()-1 >=0 && checkCell.getInt()+1<worldArray[checkCell.getX()-1][checkCell.getY()].getInt()&&!isWall(worldArray[checkCell.getX()-1][checkCell.getY()])){
				...
				worldArray[checkCell.getX()-1][checkCell.getY()].setInt(checkCell.getInt()+1);
			}
			...
			if(checkCell.getY()-1 >=0 && checkCell.getInt()+1<worldArray[checkCell.getX()][checkCell.getY()-1].getInt()&&!isWall(worldArray[checkCell.getX()][checkCell.getY()-1])){
				...
				worldArray[checkCell.getX()][checkCell.getY()-1].setInt(checkCell.getInt()+1);
			}
	...
	public void setCellHeuristic()
	{
		for(int i=1; i<6; ++i)
		{
			for(int j=1; j<9; ++j)
			{
				if(!isWall(worldArray[i][j]))
				{
					worldArray[i][j].setHeuristic(getManhattanDistance(worldArray[i][j], endCell));
					worldArray[i][j].setInt(getManhattanDistance(worldArray[i][j], endCell));
				}
			}
		}
	}
	...
	public void updateRobotWorld(Cell c)
	{
		...
		if(isWall(worldArray[c.getX()+1][c.getY()+1]))
			robotArray[c.getX()+1][c.getY()+1].setInt(-1);
